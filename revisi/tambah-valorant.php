...
<body>
    ...
    <div class="box-data">
        <form action="" method="POST">
                <input type="text" name="jumlah_vp" placeholder="Jumlah Valorant Point" class="input" required>
...
if(isset($_POST['tambah'])){
    ...
    $harga = $_POST['harga'];
    $query = "INSERT INTO data_valorant (jumlah_vp, harga) VALUES ('$jumlah_vp', '$harga')";
